...
export default {
	...
	methods: {
		submitFormHandle() {
			this.newUserIsValid.name = this.checkInputInNewUsers(
				this.newUser.name
			);
			this.newUserIsValid.email = this.checkInputInNewUsers(
				this.newUser.email
			);
			...
			this.newUserIsValid.type = this.checkInputInNewUsers(
				this.newUser.type
			);
